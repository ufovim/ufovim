...
local ftplugin_dir = ufovim.lsp.templates_dir
...
---The files are generated to a runtimepath: "$ufovim_RUNTIME_DIR/site/after/ftplugin/template.lua"
...
function M.generate_templates(servers_names)
  ...
  if not utils.is_directory(ufovim.lsp.templates_dir) then
